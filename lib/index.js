...
var ButtonDs = function (_a) {
    ...
    return (React.createElement(Button$1, { type: type, size: size, disabled: disabled, onClick: onClick }, children));
};
