...
import React__default, { useContext, isValidElement as isValidElement$1, useRef, useLayoutEffect as useLayoutEffect$1, useEffect } from 'react';
...
var Button$2 = function (_a) {
    ...
    return (React__default.createElement("button", { type: "button", className: classNames("storybook-button", "storybook-button--".concat(size), "storybook-button--".concat(type)), style: textColor ? { color: textColor } : {}, onClick: onClick }, label));
};
...
omit$1.default = omit;
var _objectSpread2$3 = _interopRequireDefault$z(objectSpread2Exports);
function omit(obj, fields) {
  var clone = (0, _objectSpread2$3.default)({}, obj);
...
Object.defineProperty(useMemo$2, "__esModule", {
  value: true
});
useMemo$2.default = useMemo$1;
...
ref.composeRef = composeRef$1;
ref.fillRef = fillRef$1;
ref.supportNodeRef = supportNodeRef$1;
ref.supportRef = supportRef$1;
ref.useComposeRef = useComposeRef$1;
var _typeof2$3 = _interopRequireDefault$y(_typeofExports);
var _react$d = React__default;
var _reactIs$1 = reactIsExports;
var _useMemo$1 = _interopRequireDefault$y(useMemo$2);
...
function supportNodeRef$1(node) {
  if (! /*#__PURE__*/(0, _react$d.isValidElement)(node)) {
    return false;
  }
...
warning$2.call = call$1;
warning$2.default = void 0;
warning$2.note = note$1;
warning$2.noteOnce = noteOnce$1;
warning$2.preMessage = void 0;
warning$2.resetWarned = resetWarned$1;
warning$2.warning = warning$1;
warning$2.warningOnce = warningOnce$1;
...
warning$2.preMessage = preMessage$1;
...
function warningOnce$1(valid, message) {
  call$1(warning$1, valid, message);
}
...
var _default$7 = warningOnce$1;
/* eslint-enable */
warning$2.default = _default$7;
...
(function (exports) {
	...
	var _warning = _interopRequireWildcard(warning$2);
	function noop() {}
	 ...
	 */
	exports.devUseWarning = process.env.NODE_ENV !== 'production' ? component => {
	  const {
	    deprecated
...
var _default$6 = function _default(element) {
  if (!element) {
    return false;
  }
...
var StyleContext = /*#__PURE__*/React$c.createContext({
  hashPriority: 'low',
  cache: createCache(),
  defaultCache: true
});
var StyleProvider = function StyleProvider(props) {
  ...
  var parentContext = React$c.useContext(StyleContext);
  var context = useMemo(function () {
    var mergedContext = _objectSpread2$2({}, parentContext);
  ...
  return /*#__PURE__*/React$c.createElement(StyleContext.Provider, {
    value: context
  }, children);
};
 ...
 */
var useInternalLayoutEffect = process.env.NODE_ENV !== 'test' && canUseDom$2() ? React$c.useLayoutEffect : React$c.useEffect;
var useLayoutEffect = function useLayoutEffect(callback, deps) {
  var firstMountRef = React$c.useRef(true);
...
var fullClone$2 = _objectSpread2$2({}, React$c);
...
var useInsertionEffectPolyfill = function useInsertionEffectPolyfill(renderEffect, effect, deps) {
  React$c.useMemo(renderEffect, deps);
...
var fullClone$1 = _objectSpread2$2({}, React$c);
...
onCacheEffect) {
  var _React$useContext = React$c.useContext(StyleContext),
...
var getComputedToken$1 = function getComputedToken(originToken, overrideToken, theme, format) {
  ...
  // Merge with override
  var mergedDerivativeToken = _objectSpread2$2(_objectSpread2$2({}, derivativeToken), overrideToken);
...
function useCacheToken(theme, tokens) {
  ...
  var mergedToken = React$c.useMemo(function () {
    return Object.assign.apply(Object, [{}].concat(_toConsumableArray(tokens)));
  }, [tokens]);
  var tokenStr = React$c.useMemo(function () {
    return flattenToken(mergedToken);
  }, [mergedToken]);
  var overrideTokenStr = React$c.useMemo(function () {
    ...
    if (typeof style === 'string') {
      ...
      Object.keys(mergedStyle).forEach(function (key) {
        ...
        if (_typeof(value) === 'object' && value && (key !== 'animationName' || !value._keyframe) && !isCompoundCSSProperty(value)) {
          ...
          effectStyle = _objectSpread2$2(_objectSpread2$2({}, effectStyle), childEffectStyle);
          styleStr += "".concat(mergedKey).concat(_parsedStr2);
        } else {
          var _value;
          function appendStyle(cssKey, cssValue) {
            if (process.env.NODE_ENV !== 'production' && (_typeof(value) !== 'object' || !(value !== null && value !== void 0 && value[SKIP_CHECK]))) {
              [linter$4, linter$3].concat(_toConsumableArray(linters)).forEach(function (linter) {
...
function useStyleRegister(info, styleFn) {
  ...
  return function (node) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = /*#__PURE__*/React$c.createElement(Empty, null);
    } else {
      var _ref6;
      styleNode = /*#__PURE__*/React$c.createElement("style", _extends({}, (_ref6 = {}, _defineProperty(_ref6, ATTR_TOKEN, cachedTokenKey), _defineProperty(_ref6, ATTR_MARK, cachedStyleId), _ref6), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return /*#__PURE__*/React$c.createElement(React$c.Fragment, null, styleNode, node);
  };
}
...
function extractStyle(cache) {
  ...
  function toStyleStr(style, tokenKey, styleId) {
    ...
    var attrs = _objectSpread2$2(_objectSpread2$2({}, customizeAttrs), {}, (_objectSpread2 = {}, _defineProperty(_objectSpread2, ATTR_TOKEN, tokenKey), _defineProperty(_objectSpread2, ATTR_MARK, styleId), _objectSpread2));
  ...
  // ==================== Fill Cache Path ====================
  styleText += toStyleStr(".".concat(ATTR_CACHE_MAP, "{content:\"").concat(serialize(cachePathMap), "\";}"), undefined, undefined, _defineProperty({}, ATTR_CACHE_MAP, ATTR_CACHE_MAP));
  return styleText;
}
...
var transform = function transform() {
  ...
  var visit = function visit(cssObj) {
    var clone = _objectSpread2$2({}, cssObj);
...
var require$$3$1 = /*@__PURE__*/getAugmentedNamespace(es$3);
...
var toArrayExports = toArray$2.exports;

var get$2 = {};

Object.defineProperty(get$2, "__esModule", {
  value: true
});
get$2.default = get$1;
...
set$2.default = set$1;
set$2.merge = merge$1;
var _typeof2$2 = _interopRequireDefault$x(_typeofExports);
var _objectSpread2$1 = _interopRequireDefault$x(objectSpread2Exports);
var _toConsumableArray2 = _interopRequireDefault$x(toConsumableArrayExports);
var _toArray2 = _interopRequireDefault$x(toArrayExports);
var _get = _interopRequireDefault$x(get$2);
function internalSet$1(entity, paths, value, removeIfUndefined) {
  ...
  if (!entity && typeof path === 'number') {
    ...
    clone = (0, _objectSpread2$1.default)({}, entity);
  }
...
validateMessagesContext.default = /*#__PURE__*/(0, _react$c.createContext)(undefined);
...
var _en_US$4 = _interopRequireDefault$w(en_US$1);
var _en_US2$1 = _interopRequireDefault$w(en_US);
...
var _en_US$3 = _interopRequireDefault$v(en_US$2);
...
var _en_US$2 = _interopRequireDefault$u(en_US$4);
var _en_US2 = _interopRequireDefault$u(en_US$3);
var _en_US3 = _interopRequireDefault$u(en_US$2);
var _en_US4 = _interopRequireDefault$u(en_US);
...
var _en_US$1 = _interopRequireDefault$t(en_US$5);
...
const LocaleContext = /*#__PURE__*/(0, _react$b.createContext)(undefined);
context$2.default = LocaleContext;
...
var React$a = _interopRequireWildcard$g(React__default);
var _context$2 = _interopRequireDefault$s(context$2);
var _en_US = _interopRequireDefault$s(en_US$5);
const useLocale = (componentName, defaultLocale) => {
  const fullLocale = React$a.useContext(_context$2.default);
  const getLocale = React$a.useMemo(() => {
    var _a;
    const locale = defaultLocale || _en_US.default[componentName];
    const localeFromContext = (_a = fullLocale === null || fullLocale === void 0 ? void 0 : fullLocale[componentName]) !== null && _a !== void 0 ? _a : {};
    return Object.assign(Object.assign({}, typeof locale === 'function' ? locale() : locale), localeFromContext || {});
  }, [componentName, defaultLocale, fullLocale]);
  const getLocaleCode = React$a.useMemo(() => {
...
var require$$2$1 = /*@__PURE__*/getAugmentedNamespace(es$2);
...
var _genRadius = _interopRequireDefault$r(genRadius$1);
...
var _genFontSizes = _interopRequireDefault$q(genFontSizes);
...
Object.defineProperty(_default$3, "__esModule", {
  value: true
});
_default$3.default = derivative;
var _colors$1 = require$$2$1;
var _genControlHeight = _interopRequireDefault$p(genControlHeight$1);
var _genSizeMapToken = _interopRequireDefault$p(genSizeMapToken$1);
var _seed$3 = seed;
var _genColorMapToken = _interopRequireDefault$p(genColorMapToken$1);
var _genCommonMapToken = _interopRequireDefault$p(genCommonMapToken$1);
var _colors2 = colors;
var _genFontMapToken = _interopRequireDefault$p(genFontMapToken$1);
...
context$1.defaultTheme = context$1.defaultConfig = context$1.DesignTokenContext = void 0;
var _cssinjs$3 = require$$3$1;
var _react$a = _interopRequireDefault$o(React__default);
var _default$2 = _interopRequireDefault$o(_default$3);
var _seed$2 = _interopRequireDefault$o(seed);
context$1.defaultTheme = (0, _cssinjs$3.createTheme)(_default$2.default);
// ================================ Context =================================
// To ensure snapshot stable. We disable hashed in test env.
const defaultConfig = context$1.defaultConfig = {
  token: _seed$2.default,
  hashed: true
};
context$1.DesignTokenContext = /*#__PURE__*/_react$a.default.createContext(defaultConfig);
...
var _version$1 = _interopRequireDefault$n(version$1);
...
var _seed$1 = _interopRequireDefault$m(seed);
var _getAlphaColor = _interopRequireDefault$m(getAlphaColor$1);
...
useToken$1.getComputedToken = void 0;
var _cssinjs$2 = require$$3$1;
var _react$9 = _interopRequireDefault$l(React__default);
var _version = _interopRequireDefault$l(version$2);
var _context$1 = context$1;
var _seed = _interopRequireDefault$l(seed);
var _alias = _interopRequireDefault$l(alias);
...
function useToken() {
  const {
    ...
    theme,
    components
  } = _react$9.default.useContext(_context$1.DesignTokenContext);
  const salt = `${_version.default}-${hashed || ''}`;
  const mergedTheme = theme || _context$1.defaultTheme;
  const [token, hashId] = (0, _cssinjs$2.useCacheToken)(mergedTheme, [_seed.default, rootDesignToken], {
    salt,
...
function useEvent(callback) {
  var fnRef = React$c.useRef();
  fnRef.current = callback;
  var memoFn = React$c.useCallback(function () {
    var _fnRef$current;
...
function useSafeState(defaultValue) {
  var destroyRef = React$c.useRef(false);
  var _React$useState = React$c.useState(defaultValue),
...
function supportNodeRef(node) {
  if (! /*#__PURE__*/isValidElement$1(node)) {
    return false;
  }
...
context.defaultIconPrefixCls = context.ConfigContext = context.ConfigConsumer = void 0;
var React$9 = _interopRequireWildcard$f(React__default);
const defaultIconPrefixCls = context.defaultIconPrefixCls = 'anticon';
...
const ConfigContext = context.ConfigContext = /*#__PURE__*/React$9.createContext({
...
context.ConfigConsumer = ConfigConsumer;
...
var _cssinjs$1 = require$$3$1;
var _style$5 = style$5;
var _useToken$2 = _interopRequireDefault$k(useToken$1);
const useResetIconStyle = (iconPrefixCls, csp) => {
  ...
  return (0, _cssinjs$1.useStyleRegister)({
    ...
    [`.${iconPrefixCls}`]: Object.assign(Object.assign({}, (0, _style$5.resetIcon)()), {
...
genComponentStyleHook$1.genSubStyleComponent = void 0;
var _react$8 = React__default;
var _cssinjs = require$$3$1;
var _rcUtil$1 = require$$3;
var _context = context;
var _style$4 = style$5;
var _useToken$1 = _interopRequireDefault$j(useToken$1);
var _statistic = _interopRequireWildcard$e(statistic$1);
var _useResetIconStyle = _interopRequireDefault$j(useResetIconStyle$1);
...
function genComponentStyleHook(componentName, styleFn, getDefaultToken) {
  ...
  return prefixCls => {
    const [theme, token, hashId] = (0, _useToken$1.default)();
    const {
      getPrefixCls,
      iconPrefixCls,
      csp
    } = (0, _react$8.useContext)(_context.ConfigContext);
    ...
    return [(0, _cssinjs.useStyleRegister)(Object.assign(Object.assign({}, sharedConfig), {
      ...
      if (options.deprecatedTokens) {
        ...
        deprecatedTokens.forEach(_ref => {
          ...
          var _a;
          if (process.env.NODE_ENV !== 'production') {
            process.env.NODE_ENV !== "production" ? (0, _rcUtil$1.warning)(!(customComponentToken === null || customComponentToken === void 0 ? void 0 : customComponentToken[oldTokenKey]), `The token '${String(oldTokenKey)}' of ${component} had deprecated, use '${String(newTokenKey)}' instead.`) : void 0;
          }
      ...
      return [options.resetStyle === false ? null : (0, _style$4.genCommonStyle)(token, prefixCls), styleInterpolation];
    }), hashId];
  };
}
...
var _canUseDom$1 = _interopRequireDefault$i(canUseDom$1);
var _contains = _interopRequireDefault$i(contains$1);
...
var _canUseDom = _interopRequireDefault$h(canUseDom$1);
var _dynamicCSS = dynamicCSS;
var _warning$4 = _interopRequireDefault$h(warning$3);
...
function registerTheme(globalPrefixCls, theme) {
  ...
  if ((0, _canUseDom.default)()) {
    ...
    process.env.NODE_ENV !== "production" ? (0, _warning$4.default)(false, 'ConfigProvider', 'SSR do not support dynamic theme with css variables.') : void 0;
  }
}
...
const DisabledContext = /*#__PURE__*/React$8.createContext(false);
const DisabledContextProvider = _ref => {
  let {
    children,
    disabled
  } = _ref;
  const originDisabled = React$8.useContext(DisabledContext);
  return /*#__PURE__*/React$8.createElement(DisabledContext.Provider, {
...
const SizeContext = /*#__PURE__*/React$7.createContext(undefined);
const SizeContextProvider = _ref => {
  let {
    children,
    size
  } = _ref;
  const originSize = React$7.useContext(SizeContext);
  return /*#__PURE__*/React$7.createElement(SizeContext.Provider, {
...
var _react$7 = React__default;
var _DisabledContext$1 = _interopRequireDefault$g(DisabledContext$1);
var _SizeContext$1 = _interopRequireDefault$g(SizeContext$1);
function useConfig() {
  const componentDisabled = (0, _react$7.useContext)(_DisabledContext$1.default);
  const componentSize = (0, _react$7.useContext)(_SizeContext$1.default);
  return {
    componentDisabled,
    componentSize
  };
...
var _typeof2$1 = _interopRequireDefault$f(_typeofExports);
var _warning$3 = _interopRequireDefault$f(warning$2);
/**
 * Deeply compares two object literals.
 * @param obj1 object 1
 * @param obj2 object 2
...
function isEqual(obj1, obj2) {
  ...
  function deepEqual(a, b) {
    var level = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var circular = refSet.has(a);
    (0, _warning$3.default)(!circular, 'Warning: There may be circular references');
    if (circular) {
      return false;
    }
    if (a === b) {
...
var _default$1 = isEqual;
isEqual$1.default = _default$1;
...
var _useMemo = _interopRequireDefault$e(useMemo$2);
var _isEqual = _interopRequireDefault$e(isEqual$1);
var _internal$6 = internal;
function useTheme(theme, parentTheme) {
  const themeConfig = theme || {};
  const parentThemeConfig = themeConfig.inherit === false || !parentTheme ? _internal$6.defaultConfig : parentTheme;
...
var Context = /*#__PURE__*/React$c.createContext({});
function MotionProvider(_ref) {
  var children = _ref.children,
    props = _objectWithoutProperties(_ref, _excluded$1);
  return /*#__PURE__*/React$c.createElement(Context.Provider, {
    value: props
  }, children);
}
...
var useDomMotionEvents = (function (callback) {
  ...
  var onInternalMotionEnd = React$c.useCallback(function (event) {
...
var useNextFrame = (function () {
  var nextFrameRef = React$c.useRef(null);
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React$c.useMemo(function () {
  ...
  var firstMountChangeRef = React$c.useRef(false);
  useEffect(function () {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = /*#__PURE__*/React$c.forwardRef(function (props, ref) {
    ...
    var _React$useContext = React$c.useContext(Context),
    ...
    var renderedRef = React$c.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }

    // ====================== Refs ======================
    var setNodeRef = React$c.useCallback(function (node) {
    ...
    if ( /*#__PURE__*/React$c.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var _ref = motionChildren,
        originNodeRef = _ref.ref;
      if (!originNodeRef) {
        motionChildren = /*#__PURE__*/React$c.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return /*#__PURE__*/React$c.createElement(DomWrapper, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(CSSMotionList, [{
      ...
      value: function render() {
        ...
        var Component = component || React$c.Fragment;
        var motionProps = {};
        ...
        return /*#__PURE__*/React$c.createElement(Component, restProps, keyEntities.map(function (_ref2, index) {
          var status = _ref2.status,
            eventProps = _objectWithoutProperties(_ref2, _excluded2);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return /*#__PURE__*/React$c.createElement(CSSMotion$1, _extends({}, motionProps, {
            key: eventProps.key,
            visible: visible,
...
function MotionWrapper(props) {
  ...
  const [, token] = (0, _internal$5.useToken)();
  const {
    motion
  } = token;
  const needWrapMotionProviderRef = React$6.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return /*#__PURE__*/React$6.createElement(_rcMotion$2.Provider, {
      motion: motion
    }, children);
  }
  return children;
...
var React$5 = _interopRequireWildcard$a(React__default);
var _warning$2 = warning$3;
/**
 * Warning for ConfigProviderProps.
 * This will be empty function in production.
 */
const PropWarning = /*#__PURE__*/React$5.memo(_ref => {
  let {
    dropdownMatchSelectWidth
  } = _ref;
  const warning = (0, _warning$2.devUseWarning)('ConfigProvider');
...
(function (exports) {
	...
	var _useMemo = _interopRequireDefault(useMemo$2);
	var _set = set$2;
	var _warning = _interopRequireDefault(warning$3);
	var _validateMessagesContext = _interopRequireDefault(validateMessagesContext);
	var _locale = _interopRequireWildcard(locale$4);
	var _context = _interopRequireDefault(context$2);
	var _en_US = _interopRequireDefault(en_US$5);
	var _context2 = context$1;
	var _internal = internal;
	...
	null;
	exports.configConsumerProps = ['getTargetContainer', 'getPopupContainer', 'rootPrefixCls', 'getPrefixCls', 'renderEmpty', 'csp', 'autoInsertSpaceInButton', 'locale', 'pageHeader'];
...
var React$4 = _interopRequireWildcard$9(React__default);
const {
  isValidElement
} = React$4;
reactNode.isValidElement = isValidElement;
function isFragment(child) {
  return child && isValidElement(child) && child.type === React$4.Fragment;
}
function replaceElement(element, replacement, props) {
  if (!isValidElement(element)) {
    return replacement;
  }
  return /*#__PURE__*/React$4.cloneElement(element, typeof props === 'function' ? props(element.props || {}) : props);
}
...
style$2.default = (0, _internal$4.genComponentStyleHook)('Wave', token => [genWaveStyle(token)]);
...
var ReactDOM = _interopRequireWildcard$8(ReactDOM$1);
...
var _classnames$6 = _interopRequireDefault$c(classnamesExports);
var _rcMotion$1 = _interopRequireDefault$c(require$$4);
...
const WaveEffect = props => {
  ...
  const divRef = React$3.useRef(null);
  const [color, setWaveColor] = React$3.useState(null);
  const [borderRadius, setBorderRadius] = React$3.useState([]);
  const [left, setLeft] = React$3.useState(0);
  const [top, setTop] = React$3.useState(0);
  const [width, setWidth] = React$3.useState(0);
  const [height, setHeight] = React$3.useState(0);
  const [enabled, setEnabled] = React$3.useState(false);
  const waveStyle = {
    left,
    top,
    width,
  ...
  return /*#__PURE__*/React$3.createElement(_rcMotion$1.default, {
    visible: true,
    motionAppear: true,
    ...
    return /*#__PURE__*/React$3.createElement("div", {
      ref: divRef,
      className: (0, _classnames$6.default)(className, {
...
const showWaveEffect = (target, info) => {
  ...
  (0, _render.render)( /*#__PURE__*/React$3.createElement(WaveEffect, Object.assign({}, info, {
    target: target
  })), holder);
};
...
var React$2 = _interopRequireWildcard$6(React__default);
...
function useWave(nodeRef, className, component) {
  const {
    wave
  } = React$2.useContext(_configProvider$4.ConfigContext);
...
wave.default = void 0;
var _classnames$5 = _interopRequireDefault$a(classnamesExports);
var _ref$1 = ref;
var _isVisible = _interopRequireDefault$a(isVisible);
var _react$6 = _interopRequireWildcard$5(React__default);
var _configProvider$3 = configProvider;
var _reactNode$1 = reactNode;
var _style$3 = _interopRequireDefault$a(style$2);
...
const Wave = props => {
  ...
  const {
    getPrefixCls
  } = (0, _react$6.useContext)(_configProvider$3.ConfigContext);
  const containerRef = (0, _react$6.useRef)(null);
  // ============================== Style ===============================
  const prefixCls = getPrefixCls('wave');
  const [, hashId] = (0, _style$3.default)(prefixCls);
  // =============================== Wave ===============================
  const showWave = (0, _useWave.default)(containerRef, (0, _classnames$5.default)(prefixCls, hashId), component);
  // ============================== Effect ==============================
  _react$6.default.useEffect(() => {
  ...
  // ============================== Render ==============================
  if (! /*#__PURE__*/_react$6.default.isValidElement(children)) {
    return children !== null && children !== void 0 ? children : null;
  }
  const ref = (0, _ref$1.supportRef)(children) ? (0, _ref$1.composeRef)(children.ref, containerRef) : containerRef;
  return (0, _reactNode$1.cloneElement)(children, {
    ref
  });
};
if (process.env.NODE_ENV !== 'production') {
...
var _react$5 = _interopRequireDefault$9(React__default);
var _SizeContext = _interopRequireDefault$9(SizeContext$1);
const useSize = customSize => {
  const size = _react$5.default.useContext(_SizeContext.default);
  const mergedSize = _react$5.default.useMemo(() => {
    if (!customSize) {
      return size;
    }
...
function toArray(children) {
  var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var ret = [];
  _react$4.default.Children.forEach(children, function (child) {
...
var _compact = _interopRequireDefault$7(compact);
...
// ============================== Export ==============================
style$1.default = (0, _internal$3.genComponentStyleHook)('Space', token => {
  const spaceToken = (0, _internal$3.mergeToken)(token, {
...
var _toArray = _interopRequireDefault$6(toArray$1);
var React$1 = _interopRequireWildcard$4(React__default);
var _configProvider$2 = configProvider;
var _useSize$1 = _interopRequireDefault$6(useSize$1);
var _style$2 = _interopRequireDefault$6(style$1);
...
const SpaceCompactItemContext = Compact$1.SpaceCompactItemContext = /*#__PURE__*/React$1.createContext(null);
const useCompactItemContext = (prefixCls, direction) => {
  ...
  const compactItemClassnames = React$1.useMemo(() => {
    ...
    return (0, _classnames$4.default)(`${prefixCls}-compact${separator}item`, {
...
const NoCompactStyle = _ref => {
  ...
  return /*#__PURE__*/React$1.createElement(SpaceCompactItemContext.Provider, {
    value: null
  }, children);
};
...
const CompactItem = _a => {
  var {
    ...
    otherProps = __rest$2(_a, ["children"]);
  return /*#__PURE__*/React$1.createElement(SpaceCompactItemContext.Provider, {
    value: otherProps
  }, children);
};
const Compact = props => {
  ...
  } = React$1.useContext(_configProvider$2.ConfigContext);
  const {
      size,
      direction,
      block,
    ...
    restProps = __rest$2(props, ["size", "direction", "block", "prefixCls", "className", "rootClassName", "children"]);
  const mergedSize = (0, _useSize$1.default)(ctx => size !== null && size !== void 0 ? size : ctx);
  const prefixCls = getPrefixCls('space-compact', customizePrefixCls);
  const [wrapSSR, hashId] = (0, _style$2.default)(prefixCls);
  const clx = (0, _classnames$4.default)(prefixCls, hashId, {
  ...
  const nodes = React$1.useMemo(() => childNodes.map((child, i) => {
    const key = child && child.key || `${prefixCls}-item-${i}`;
    return /*#__PURE__*/React$1.createElement(CompactItem, {
      key: key,
  ...
  return wrapSSR( /*#__PURE__*/React$1.createElement("div", Object.assign({
    className: clx
  }, restProps), nodes));
};
...
var React = _interopRequireWildcard$3(React__default);
var _classnames$3 = _interopRequireDefault$5(classnamesExports);
var _warning$1 = warning$3;
...
const ButtonGroup = props => {
  const {
    getPrefixCls,
    direction
  } = React.useContext(_configProvider$1.ConfigContext);
  const {
      prefixCls: customizePrefixCls,
      size,
      className
  ...
  if (process.env.NODE_ENV !== 'production') {
    const warning = (0, _warning$1.devUseWarning)('Button.Group');
    process.env.NODE_ENV !== "production" ? warning(!size || ['large', 'small', 'middle'].includes(size), 'usage', 'Invalid prop `size`.') : void 0;
  }
  const classes = (0, _classnames$3.default)(prefixCls, {
...
var _react$3 = _interopRequireDefault$4(React__default);
...
const IconWrapper = /*#__PURE__*/(0, _react$2.forwardRef)((props, ref) => {
  const {
    className,
    style,
    children,
  ...
  const iconWrapperCls = (0, _classnames$2.default)(`${prefixCls}-icon`, className);
...
(function (exports) {
	...
	var _dynamicCSS = dynamicCSS;
	var _shadow = shadow;
	var _warning = /*#__PURE__*/ _interop_require_default(warning$2);
	var _react = /*#__PURE__*/ _interop_require_wildcard(React__default);
	var _Context = /*#__PURE__*/ _interop_require_default(Context$1);
...
var _LoadingOutlined = _interopRequireDefault$2(LoadingOutlinedExports);
var _classnames$1 = _interopRequireDefault$2(classnamesExports);
var _rcMotion = _interopRequireDefault$2(require$$4);
var _react$1 = _interopRequireWildcard$1(React__default);
var _IconWrapper$1 = _interopRequireDefault$2(IconWrapper$1);
const InnerLoadingIcon = /*#__PURE__*/(0, _react$1.forwardRef)((_ref, ref) => {
  let {
    prefixCls,
    className,
    style,
  ...
  const mergedIconCls = (0, _classnames$1.default)(`${prefixCls}-loading-icon`, className);
  return /*#__PURE__*/_react$1.default.createElement(_IconWrapper$1.default, {
    prefixCls: prefixCls,
    className: mergedIconCls,
    style: style,
    ref: ref
  }, /*#__PURE__*/_react$1.default.createElement(_LoadingOutlined.default, {
...
const LoadingIcon = props => {
  ...
  if (existIcon) {
    return /*#__PURE__*/_react$1.default.createElement(InnerLoadingIcon, {
      prefixCls: prefixCls,
      className: className,
      style: style
    });
  }
  return /*#__PURE__*/_react$1.default.createElement(_rcMotion.default, {
    visible: visible,
...
style.prepareToken = style.prepareComponentToken = style.default = void 0;
var _style$1 = style$5;
var _internal$1 = internal;
var _group = _interopRequireDefault$1(group);
// ============================== Shared ==============================
const genSharedButtonStyle = token => {
  ...
  return {
    [componentCls]: {
      ...
      '&:not(:disabled)': Object.assign({}, (0, _style$1.genFocusStyle)(token)),
...
const genSizeBaseButtonStyle = token => genSizeButtonStyle((0, _internal$1.mergeToken)(token, {
...
const prepareToken = token => {
  ...
  const buttonToken = (0, _internal$1.mergeToken)(token, {
    buttonPaddingHorizontal: paddingInline,
    buttonIconOnlyFontSize: onlyIconSize
  });
  return buttonToken;
};
style.prepareToken = prepareToken;
...
style.prepareComponentToken = prepareComponentToken;
style.default = (0, _internal$1.genComponentStyleHook)('Button', token => {
...
var _omit = _interopRequireDefault(omit$1);
var _ref = ref;
var _warning = warning$3;
var _wave = _interopRequireDefault(wave);
var _configProvider = configProvider;
var _DisabledContext = _interopRequireDefault(DisabledContext$1);
var _useSize = _interopRequireDefault(useSize$1);
var _Compact = Compact$1;
var _buttonGroup = _interopRequireWildcard(buttonGroup);
var _buttonHelpers = buttonHelpers;
var _IconWrapper = _interopRequireDefault(IconWrapper$1);
var _LoadingIcon = _interopRequireDefault(LoadingIcon$1);
var _style = _interopRequireDefault(style);
var _compactCmp = _interopRequireDefault(compactCmp);
var __rest = function (s, e) {
  var t = {};
  for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p) && e.indexOf(p) < 0) t[p] = s[p];
  if (s != null && typeof Object.getOwnPropertySymbols === "function") for (var i = 0, p = Object.getOwnPropertySymbols(s); i < p.length; i++) {
...
const Button$1 = /*#__PURE__*/(0, _react.forwardRef)(InternalButton);
if (process.env.NODE_ENV !== 'production') {
  Button$1.displayName = 'Button';
}
Button$1.Group = _buttonGroup.default;
...
var Button = /*@__PURE__*/getDefaultExportFromCjs(button$1);

/**
 * Primary UI component for user interaction
 */
var ButtonDs = function (_a) {
    _a.type; _a.size; var children = _a.children, onClick = _a.onClick;
    return (React__default.createElement(Button, { onClick: onClick }, children));
};

export { Button$2 as Button, ButtonDs };
